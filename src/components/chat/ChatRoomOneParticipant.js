      ...
      <Collapse in={isCollapse}>
        <Stack spacing={2} sx={{ p: 2.5, pt: 1 }}>
          <Stack direction="row" spacing={1}>
            ...
            <RowTextStyle>{participant.address !== undefined ? participant.address : 'No Location'}</RowTextStyle>
          </Stack>
          <Stack direction="row" spacing={1}>
            <RowIconStyle icon={phoneFill} />
            <RowTextStyle>{participant.phone !== undefined ? participant.phone : 'No phone'}</RowTextStyle>
          </Stack>
          <Stack direction="row" spacing={1}>
            <RowIconStyle icon={emailFill} />
            <RowTextStyle>{participant.email !== undefined ? participant.email : 'No email'}</RowTextStyle>
          </Stack>
        </Stack>
      </Collapse>
    </Box>
